          ...
          <div>
            ...
            <div className="code-block text-green-400 font-mono text-sm mb-8">
              <div className="flex items-center justify-between mb-2">
                ...
                <button onClick={() => copyCode('npm install rc-bullets-ts')} className="text-blue-400 hover:text-blue-300">
              ...
              <div className="flex items-center justify-between mb-2">
                ...
                <button onClick={() => copyCode('yarn add rc-bullets-ts')} className="text-blue-400 hover:text-blue-300">
                  <i className="fas fa-copy"></i>
                </button>
              </div>
